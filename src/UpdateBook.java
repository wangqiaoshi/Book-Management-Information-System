...
public class UpdateBook extends JPanel{
	...
	public UpdateBook(){
		...
		button2.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
				try{
					String sqlstr2 = "update books set bookname='"+bookname.getText()+"',publish='"+publish.getText()+"',author='"+author.getText()+"',isbn='"+isbn.getText()+"',price='"+price.getText()+"' where number='"+number.getText()+"'";
					int k = -1;
